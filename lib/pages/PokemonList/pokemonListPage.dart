...
import 'package:pokedex/helper/colorTheme.dart';
import 'package:pokedex/model/pokemon.dart';
import 'package:pokedex/model/pokemonList.dart';
import 'package:pokedex/scoped_model/pokemonState.dart';
import 'package:pokedex/widgets/customWidget.dart';
...
class _PokemonListPageState extends State<PokemonListPage>
  ...
  Widget _rightTopSearchIcon() {
    ...
    return Padding(
        ...
        child: IconButton(
          iconSize: getDimention(context, 40),
  ...
  void openPokemonshortDetail(PokemonListModel model) async {
    print(model.name);
    var _panelHeight = getFontSize(context, 325);
                  ...
                  SliverAppBar(
                    ...
                    flexibleSpace: Container(
                      ...
                      child: Text(
                        'Pokedex',
                        style: TextStyle(
                            fontSize: getFontSize(context, 40),
                            fontWeight: FontWeight.w800),
                      ),
                    ),
                    expandedHeight: getDimention(context, 150),
                  ),
                  _pokemonList()
                ],
              ),
